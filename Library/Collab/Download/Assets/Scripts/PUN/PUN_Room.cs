...
public class PUN_Room : MonoBehaviourPunCallbacks, IInRoomCallbacks {
	...
	void Update () {
		...
		//		if (readyToStart)
		//		{
		//			atMaxPlayers -= timeToStart.deltaTime;
		//			lessThanMaxPlayers = atMaxPlayers;
		//			timeToStart = atMaxPlayers;
		//		}
		//		else
		//		{
		//			lessThanMaxPlayers -= timeToStart.deltaTime;
	...
	public override void OnJoinedRoom()
	{
		...
		//if (MultiplayerSetting.multiplayerSetting.delayStart)
		//{
		//	Debug.Log("Displayer players in room out of max players possible (" + playersInRoom + ":" + MultiplayerSetting.multiplayerSetting.delayStart);
		//	if(playersInRoom > 1)
		//	{
		//		readyToCount = true;
		//	}
