...
public class Multiplayer_statemachine : MonoBehaviour {
	...
	public GameObject findingButton;
	...
	public void OnFindingButtonClicked(){
		Debug.Log("Finding the next opponent");
